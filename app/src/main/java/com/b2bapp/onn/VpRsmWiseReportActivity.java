...
public class VpRsmWiseReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vp_rsm_wise_report);
        ...
        primarySalesReportAdapter = new PrimarySalesReportAdapter(VpRsmWiseReportActivity.this,primarySalesModelArrayList);
        primaryList.setAdapter(primarySalesReportAdapter);

        asmSalesAdapter = new AsmSalesAdapter(VpRsmWiseReportActivity.this,asmSalesModelArrayList);
        ...
        primaryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                startActivity(new Intent(VpRsmWiseReportActivity.this, AseDistributorOrderListActivity.class));
        ...
        secondaryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                RsmAsmWiseTeamReportActivity.coming_from = "vp1";
                startActivity(new Intent(VpRsmWiseReportActivity.this, RsmAsmWiseTeamReportActivity.class));
                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                finish();
            }
        });
        ...
        tvName.setText(GlobalVariable.vp_rsm_name);

        getAllData();
    }

    private void getAllData(){
        dialogView.showCustomSpinProgress(VpRsmWiseReportActivity.this);
        Map<String, String> postParam= new HashMap<String, String>();
        postParam.put("rsm", GlobalVariable.vp_rsm_name);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                dialogView.showSingleButtonDialog(VpRsmWiseReportActivity.this, getResources().getString(R.string.app_name),
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(VpRsmWiseReportActivity.this, VpTeamWiseReportResultActivity.class);
