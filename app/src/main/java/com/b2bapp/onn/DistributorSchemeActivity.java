...
public class DistributorSchemeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributor_scheme);
        ...
        schemeAdapter = new SchemeAdapter(DistributorSchemeActivity.this,currentSchemeModelArrayList);
...
//                finish();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.tvOld:
                ...
                schemeAdapter = new SchemeAdapter(DistributorSchemeActivity.this,oldSchemeModelArrayList);
                gvSchemes.setAdapter(schemeAdapter);
                break;
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(DistributorSchemeActivity.this, DistributorDashboardActivity.class);
    ...
    public void getSchemesTask(){
        dialogView.showCustomSpinProgress(DistributorSchemeActivity.this);
