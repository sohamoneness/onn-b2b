...
public class VpProductWiseReportResultActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vp_product_wise_report_result);
        ...
        vp = pref.getStringPreference(VpProductWiseReportResultActivity.this,Preferences.User_fname)
                + " "+ pref.getStringPreference(VpProductWiseReportResultActivity.this,Preferences.User_lname);
        ...
        productWiseSalesAdapter = new ProductWiseSalesAdapter(VpProductWiseReportResultActivity.this,productWiseSalesModelArrayList);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(VpProductWiseReportResultActivity.this, VpProductWiseReportActivity.class);
    ...
    private void getAllData(){
        dialogView.showCustomSpinProgress(VpProductWiseReportResultActivity.this);
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                WebServices.URL_VP_WISE_PRODUCT_REPORT, new JSONObject(postParam),
...
//                                        dataModel.setProductWiseSalesDetailsModelArrayList(productWiseSalesDetailsModelArrayList);
                                ...
                                dialogView.showSingleButtonDialog(VpProductWiseReportResultActivity.this, getResources().getString(R.string.app_name),
