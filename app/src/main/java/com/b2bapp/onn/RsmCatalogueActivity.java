...
public class RsmCatalogueActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsm_catalogue);
...
//        gvCategories.setAdapter(catelogueCategoryAdapter);
        ...
        catalogueAdapter = new CatalogueAdapter(RsmCatalogueActivity.this, catalogueModelArrayList);
...
//                finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(RsmCatalogueActivity.this, RsmDashboardActivity.class);
    ...
    public void getCatalogueTask(){
        dialogView.showCustomSpinProgress(RsmCatalogueActivity.this);
