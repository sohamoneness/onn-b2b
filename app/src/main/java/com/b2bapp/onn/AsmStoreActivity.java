...
public class AsmStoreActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asm_store);
        ...
        asmAdapter = new VpStoreAdapter(AsmStoreActivity.this, asmModelArrayList);
        ...
        asmList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                AsmStoreOrdersActivity.storeId = asmModelArrayList.get(i).getStore_id();
                ProductListActivity.coming_from = "asm";
                startActivity(new Intent(AsmStoreActivity.this, ProductListActivity.class));
    ...
    private void getAllData(String state, String distributor){
        dialogView.showCustomSpinProgress(AsmStoreActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                dialogView.showSingleButtonDialog(AsmStoreActivity.this, getResources().getString(R.string.app_name),
    ...
    public void onBackPressed() {
        if (coming_from.equals("distributor")){
            super.onBackPressed();
            Intent intent = new Intent(AsmStoreActivity.this, AsmDistributorActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }else{
            super.onBackPressed();
            Intent intent = new Intent(AsmStoreActivity.this, AsmWiseAseActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }
