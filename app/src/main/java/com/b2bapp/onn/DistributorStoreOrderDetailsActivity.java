...
public class DistributorStoreOrderDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributor_store_order_details);
        ...
        itemAdapter = new ItemAdapter(DistributorStoreOrderDetailsActivity.this,itemModelArrayList);
    ...
    public void getOrderDetailsTask(){
        dialogView.showCustomSpinProgress(DistributorStoreOrderDetailsActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(DistributorStoreOrderDetailsActivity.this, DistributorStoreOrdersActivity.class);
