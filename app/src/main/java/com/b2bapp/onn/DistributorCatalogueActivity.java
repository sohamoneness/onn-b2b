...
public class DistributorCatalogueActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributor_catalogue);
...
//        gvCategories.setAdapter(catelogueCategoryAdapter);
        ...
        catalogueAdapter = new CatalogueAdapter(DistributorCatalogueActivity.this, catalogueModelArrayList);
...
//                finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(DistributorCatalogueActivity.this, DistributorDashboardActivity.class);
    ...
    public void getCategoryListTask(){
        dialogView.showCustomSpinProgress(DistributorCatalogueActivity.this);
