...
public class AsmAdapter extends BaseAdapter {
    ArrayList<AsmModel> rsmModelArrayList;
    Activity mActivity;
    LayoutInflater inflater;
    Activity context;

    public AsmAdapter(Activity activity, ArrayList<AsmModel> rsmModelArrayList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        AsmModel rsmModel = rsmModelArrayList.get(position);

        if (view == null) {
            view = inflater.inflate(R.layout.inflate_asm_list, parent, false);
        }
