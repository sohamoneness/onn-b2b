...
public class RegionAdapter extends BaseAdapter {
    ArrayList<RegionModel> rsmModelArrayList;
    Activity mActivity;
    LayoutInflater inflater;
    Activity context;

    public RegionAdapter(Activity activity, ArrayList<RegionModel> rsmModelArrayList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        RegionModel rsmModel = rsmModelArrayList.get(position);

        if (view == null) {
            view = inflater.inflate(R.layout.inflate_region_list, parent, false);
        }
