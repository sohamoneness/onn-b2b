...
public class Rsm1Adapter extends BaseAdapter {
    ArrayList<RsmModel> rsmModelArrayList;
    Activity mActivity;
    LayoutInflater inflater;
    Activity context;

    public Rsm1Adapter(Activity activity, ArrayList<RsmModel> rsmModelArrayList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.inflate_rsm_list1, parent, false);
        }
