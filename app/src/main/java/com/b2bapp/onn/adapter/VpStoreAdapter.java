...
public class VpStoreAdapter extends BaseAdapter {
    ArrayList<VpStoreModel> rsmModelArrayList;
    Activity mActivity;
    LayoutInflater inflater;
    Activity context;

    public VpStoreAdapter(Activity activity, ArrayList<VpStoreModel> rsmModelArrayList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        VpStoreModel rsmModel = rsmModelArrayList.get(position);
