...
public class DistributorCartAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DistributorCartAdapter(Activity activity, ArrayList<CartModel> cartModelArrayList) {
    ...
    public void deleteCartTask(int pos,String cartId){
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                WebServices.URL_DISTRIBUTOR_DELETE_CART+"/"+cartId, new JSONObject(postParam),
