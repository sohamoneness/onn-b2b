...
public class AsmStoreOrderDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asm_store_order_details);
        ...
        itemAdapter = new ItemAdapter(AsmStoreOrderDetailsActivity.this,itemModelArrayList);
    ...
    public void getOrderDetailsTask(){
        dialogView.showCustomSpinProgress(AsmStoreOrderDetailsActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AsmStoreOrderDetailsActivity.this, AsmStoreOrdersActivity.class);
