...
public class StoreOrderDetailsActivity extends AppCompatActivity implements View.OnClickListener {

    private TextView tvStoreName, tvStoreCode, tvSalesPerson, tvOrderNo, tvDate, tvArea, tvAddress, tvMobile, tvCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemAdapter = new ItemAdapter(StoreOrderDetailsActivity.this,itemModelArrayList);
    ...
    public void getOrderDetailsTask(){
        dialogView.showCustomSpinProgress(StoreOrderDetailsActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                tvArea.setText(orderObj.getJSONObject("stores").getString("address")+" , "+orderObj.getJSONObject("stores").getString("area")
                                        +" , Pin : "+orderObj.getJSONObject("stores").getString("pin"));
                                tvAddress.setText(
                                ...
                                for (int i=0;i<itemModelArrayList.size();i++){
                                    total_items+= Integer.parseInt(itemModelArrayList.get(i).getQty());
                                }

                                tvCount.setText("Total Items : "+String.valueOf(total_items)+" Pcs");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        if (coming_from.equals("store")){
            Intent intent = new Intent(StoreOrderDetailsActivity.this, StoreOrderListActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }else{
            Intent intent = new Intent(StoreOrderDetailsActivity.this, MyOrdersActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }
