...
public class VpTeamWiseReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vp_team_wise_report);
        ...
        vp = pref.getStringPreference(VpTeamWiseReportActivity.this,Preferences.User_fname)
                + " "+ pref.getStringPreference(VpTeamWiseReportActivity.this,Preferences.User_lname);
        ...
        spinCollectionAdapter = new SpinCollectionAdapter(collectionModelArrayList,VpTeamWiseReportActivity.this);
        ...
        etStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(VpTeamWiseReportActivity.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        etEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(VpTeamWiseReportActivity.this,date1,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        areaAdapter = new AreaAdapter(areaModelArrayList, VpTeamWiseReportActivity.this);
        spinAreas.setAdapter(areaAdapter);

        stateAdapter = new AreaAdapter(stateModelArrayList, VpTeamWiseReportActivity.this);
    ...
    public void getCollectionWiseProductStyles(String collectionId) {
        dialogView.showCustomSpinProgress(VpTeamWiseReportActivity.this);
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                if (searchCollectionModelArrayList.size() > 0) {
                                    ...
                                    ArrayAdapter<String> spinnerPhoneArrayAdapter2 = new ArrayAdapter<String>(VpTeamWiseReportActivity.this, R.layout.spinner_item, products);
    ...
    public void submitReportData(){
        ...
        startActivity(new Intent(VpTeamWiseReportActivity.this, VpTeamWiseReportResultActivity.class));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(VpTeamWiseReportActivity.this, VpStartingActivity.class);
