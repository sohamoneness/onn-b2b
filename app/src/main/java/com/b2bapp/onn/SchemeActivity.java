...
public class SchemeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schemeAdapter = new SchemeAdapter(SchemeActivity.this,currentSchemeModelArrayList);
...
//                finish();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.tvOld:
                ...
                schemeAdapter = new SchemeAdapter(SchemeActivity.this,oldSchemeModelArrayList);
                gvSchemes.setAdapter(schemeAdapter);
                break;
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(SchemeActivity.this, TaskActivity.class);
    ...
    public void getSchemesTask(){
        dialogView.showCustomSpinProgress(SchemeActivity.this);
