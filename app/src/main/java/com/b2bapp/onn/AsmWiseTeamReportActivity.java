...
public class AsmWiseTeamReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asm_wise_team_report);
        ...
        spinCollectionAdapter = new SpinCollectionAdapter(collectionModelArrayList,AsmWiseTeamReportActivity.this);
        ...
        etStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(AsmWiseTeamReportActivity.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        etEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(AsmWiseTeamReportActivity.this,date1,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });

        if (GlobalVariable.asm_report_date_from.equals("")){
            etStartDate.setText(start);
        }else{
            etStartDate.setText(GlobalVariable.asm_report_date_from);
        }

        if (GlobalVariable.asm_report_date_to.equals("")){
            etEndDate.setText(end);
        }else{
            etEndDate.setText(GlobalVariable.asm_report_date_to);
        }

        //etProductStyle.setText(GlobalVariable.asm_report_style_no);
    }

    private void getCollectionWiseProductStyles(String selected_collection) {
        dialogView.showCustomSpinProgress(AsmWiseTeamReportActivity.this);
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                if (searchCollectionModelArrayList.size() > 0) {
                                    ...
                                    ArrayAdapter<String> spinnerPhoneArrayAdapter2 = new ArrayAdapter<String>(AsmWiseTeamReportActivity.this, R.layout.spinner_item, products);
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                for (int i=0;i<collectionModelArrayList.size();i++){
                                    if (collectionModelArrayList.get(i).getId().equals(GlobalVariable.asm_report_collection)){
    ...
    public void submitReportData(){
        GlobalVariable.asm_report_date_from = etStartDate.getText().toString();
        GlobalVariable.asm_report_date_to = etEndDate.getText().toString();
        GlobalVariable.asm_report_collection = selected_collection;
        //GlobalVariable.asm_report_style_no = etProductStyle.getText().toString();

        startActivity(new Intent(AsmWiseTeamReportActivity.this, AsmWiseTeamReportResultActivity.class));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AsmWiseTeamReportActivity.this, AsmDashboardActivity.class);
