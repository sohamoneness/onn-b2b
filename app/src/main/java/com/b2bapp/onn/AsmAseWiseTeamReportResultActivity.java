...
public class AsmAseWiseTeamReportResultActivity extends AppCompatActivity implements View.OnClickListener {

    private ImageView imgBack;
    private LinearLayout liTypeSelection, liPrimary, liSecondary;
    private ListView primaryList, secondaryList;
    private TextView tvPrimary, tvSecondary, tvName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asm_ase_wise_team_report_result);
        ...
        //userId = pref.getStringPreference(AsmAseWiseTeamReportResultActivity.this,Preferences.Id);

        tvName = (TextView) findViewById(R.id.tvName);
        tvName.setText(GlobalVariable.asm_ase_name);
        ...
        primarySalesReportAdapter = new PrimarySalesReportAdapter(AsmAseWiseTeamReportResultActivity.this,primarySalesModelArrayList);
        primaryList.setAdapter(primarySalesReportAdapter);

        secondarySalesReportAdapter = new SecondarySalesReportAdapter(AsmAseWiseTeamReportResultActivity.this,secondarySalesModelArrayList);
        ...
        primaryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                AseDistributorOrderListActivity.coming_from = "asm_ase_store_wise_report";
                AseDistributorOrderListActivity.userId = primarySalesModelArrayList.get(i).getDistributor_id();
                startActivity(new Intent(AsmAseWiseTeamReportResultActivity.this, AseDistributorOrderListActivity.class));
        ...
        secondaryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                StoreOrderListActivity.coming_from = "asm_ase_store_wise_report";
                startActivity(new Intent(AsmAseWiseTeamReportResultActivity.this, StoreOrderListActivity.class));
                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                finish();
            }
        });
    ...
    private void getAllData(){
        dialogView.showCustomSpinProgress(AsmAseWiseTeamReportResultActivity.this);
        Map<String, String> postParam= new HashMap<String, String>();
        postParam.put("ase_id", GlobalVariable.store_report_ase_id);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                dialogView.showSingleButtonDialog(AsmAseWiseTeamReportResultActivity.this, getResources().getString(R.string.app_name),
    ...
    public void onBackPressed() {
        if (coming_from.equals("rsm")){
            super.onBackPressed();
            Intent intent = new Intent(AsmAseWiseTeamReportResultActivity.this, RsmAsmWiseTeamReportActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }else{
            super.onBackPressed();
            Intent intent = new Intent(AsmAseWiseTeamReportResultActivity.this, AsmWiseTeamReportResultActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }
