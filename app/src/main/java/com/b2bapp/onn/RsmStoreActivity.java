...
public class RsmStoreActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsm_store);
        ...
        asmAdapter = new VpStoreAdapter(RsmStoreActivity.this, asmModelArrayList);
        ...
        asmList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                RsmStoreOrdersActivity.storeId = asmModelArrayList.get(i).getStore_id();
                startActivity(new Intent(RsmStoreActivity.this, RsmStoreOrdersActivity.class));
    ...
    private void getAllData(String state, String distributor){
        dialogView.showCustomSpinProgress(RsmStoreActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                dialogView.showSingleButtonDialog(RsmStoreActivity.this, getResources().getString(R.string.app_name),
    ...
    public void onBackPressed() {
        if (coming_from.equals("distributor")){
            super.onBackPressed();
            Intent intent = new Intent(RsmStoreActivity.this, RsmDistributorActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }else{
            super.onBackPressed();
            Intent intent = new Intent(RsmStoreActivity.this, RsmAseActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }
