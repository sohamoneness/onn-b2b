...
public class AsmWiseTeamReportResultActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asm_wise_team_report_result);
        ...
        asm = pref.getStringPreference(AsmWiseTeamReportResultActivity.this,Preferences.User_fname)
                + " "+ pref.getStringPreference(AsmWiseTeamReportResultActivity.this,Preferences.User_lname);
        ...
        primarySalesReportAdapter = new PrimarySalesReportAdapter(AsmWiseTeamReportResultActivity.this,primarySalesModelArrayList);
        primaryList.setAdapter(primarySalesReportAdapter);

        aseSalesReportAdapter = new AseSalesReportAdapter(AsmWiseTeamReportResultActivity.this,aseSalesModelArrayList);
        ...
        primaryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                AseDistributorOrderListActivity.coming_from = "asm_store_wise_report";
                AseDistributorOrderListActivity.userId = primarySalesModelArrayList.get(i).getDistributor_id();
                startActivity(new Intent(AsmWiseTeamReportResultActivity.this, AseDistributorOrderListActivity.class));
        ...
        secondaryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AsmAseWiseTeamReportResultActivity.coming_from = "asm";
                startActivity(new Intent(AsmWiseTeamReportResultActivity.this, AsmAseWiseTeamReportResultActivity.class));
                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                finish();
            }
        });
    ...
    private void getAllData(){
        dialogView.showCustomSpinProgress(AsmWiseTeamReportResultActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                dialogView.showSingleButtonDialog(AsmWiseTeamReportResultActivity.this, getResources().getString(R.string.app_name),
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AsmWiseTeamReportResultActivity.this, AsmWiseTeamReportActivity.class);
