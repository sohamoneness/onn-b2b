...
public class RsmTeamWiseReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsm_team_wise_report);
        ...
        rsm = pref.getStringPreference(RsmTeamWiseReportActivity.this,Preferences.User_fname)
                + " "+ pref.getStringPreference(RsmTeamWiseReportActivity.this,Preferences.User_lname);
        ...
        spinCollectionAdapter = new SpinCollectionAdapter(collectionModelArrayList,RsmTeamWiseReportActivity.this);
        ...
        etStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(RsmTeamWiseReportActivity.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        etEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(RsmTeamWiseReportActivity.this,date1,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        areaAdapter = new AreaAdapter(areaModelArrayList, RsmTeamWiseReportActivity.this);
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                if (searchCollectionModelArrayList.size() > 0) {
                                    ...
                                    ArrayAdapter<String> spinnerPhoneArrayAdapter2 = new ArrayAdapter<String>(RsmTeamWiseReportActivity.this, R.layout.spinner_item, products);
    ...
    public void submitReportData(){
        ...
        startActivity(new Intent(RsmTeamWiseReportActivity.this, RsmTeamWiseReportResultActivity.class));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(RsmTeamWiseReportActivity.this, RsmDashboardActivity.class);
