...
public class DistributorProductSearchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributor_product_search);
        ...
        userId = pref.getStringPreference(DistributorProductSearchActivity.this,Preferences.Id);
        ...
        productListAdapter = new ProductListAdapter(DistributorProductSearchActivity.this,productModelArrayList);
        ...
        sizeAdapter = new DistributorSizeAdapter(DistributorProductSearchActivity.this,sizeModelArrayList);
        sizeList.setAdapter(sizeAdapter);

        spinColor = (Spinner) findViewById(R.id.spinColor);
        colorAdapter = new ColorAdapter(colorModelArrayList,DistributorProductSearchActivity.this);
        ...
        spinColor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //Calling getProductColorTask method
                getProductSizesTask(productModel.getId(),colorModelArrayList.get(i).getId());
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(DistributorProductSearchActivity.this, DistributorProductsActivity.class);
    ...
    public void searchProductTask(String keyword){
        dialogView.showCustomSpinProgress(DistributorProductSearchActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                startActivity(new Intent(DistributorProductSearchActivity.this, DistributorReviewActivity.class));
                                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                                finish();
                            }else {
                                dialogView.showSingleButtonDialog(DistributorProductSearchActivity.this, getResources().getString(R.string.app_name),
