...
public class AseProductWiseReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ase_product_wise_report);
        ...
        spinCollectionAdapter = new SpinCollectionAdapter(collectionModelArrayList,AseProductWiseReportActivity.this);
        ...
        etStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(AseProductWiseReportActivity.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        etEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(AseProductWiseReportActivity.this,date1,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
    ...
    private void getCollectionWiseProductStyles(String selected_collection) {
        dialogView.showCustomSpinProgress(AseProductWiseReportActivity.this);
    ...
    public void submitReportData(){
        ...
        startActivity(new Intent(AseProductWiseReportActivity.this, AseProductWiseReportResultActivity.class));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AseProductWiseReportActivity.this, TaskActivity.class);
