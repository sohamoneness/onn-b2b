...
public class VpStoreOrdersActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vp_store_orders);
        ...
        storeOrderAdapter = new StoreOrderAdapter(VpStoreOrdersActivity.this,orderModelArrayList);
        ...
        orderList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                VpStoreOrderDetailsActivity.orderModel = orderModelArrayList.get(i);
                startActivity(new Intent(VpStoreOrdersActivity.this, VpStoreOrderDetailsActivity.class));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(VpStoreOrdersActivity.this, VpStoreActivity.class);
    ...
    public void getStoreListTask(){
        dialogView.showCustomSpinProgress(VpStoreOrdersActivity.this);
