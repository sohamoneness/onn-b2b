...
public class AseStoreWiseReportActivity extends AppCompatActivity implements View.OnClickListener {

    private ImageView imgBack;
    private EditText etStartDate, etEndDate;
    //private AutoCompleteTextView etProductStyle;
    private Spinner spinCollection, productStyleSp;
    private Button btnSubmit;

    RequestQueue mQueue;
    DialogView dialogView;
    private String TAG = "AseStoreWiseReportActivity";
    Preferences pref;
    ...
    //String[] products={"Android ","java","IOS","SQL","JDBC","Web services"};
    String[] products = {};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ase_store_wise_report);
        ...
        spinCollectionAdapter = new SpinCollectionAdapter(collectionModelArrayList, AseStoreWiseReportActivity.this);
        ...
        etStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(AseStoreWiseReportActivity.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        etEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(AseStoreWiseReportActivity.this, date1, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });

        if (GlobalVariable.store_report_date_from.equals("")) {
            etStartDate.setText(start);
        } else {
            etStartDate.setText(GlobalVariable.store_report_date_from);
        }

        if (GlobalVariable.store_report_date_to.equals("")) {
            etEndDate.setText(end);
        } else {
            etEndDate.setText(GlobalVariable.store_report_date_to);
        }

        //etProductStyle.setText(GlobalVariable.store_report_style_no);

        // adapter = new ArrayAdapter(this,android.R.layout.simple_list_item_1,products);
        // etProductStyle.setAdapter(adapter);
        // etProductStyle.setThreshold(1);
    }
    ...
    public void getCollectionList() {
        dialogView.showCustomSpinProgress(AseStoreWiseReportActivity.this);
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                for (int i = 0; i < collectionModelArrayList.size(); i++) {
                                    if (collectionModelArrayList.get(i).getId().equals(GlobalVariable.store_report_collection)) {
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                if (searchCollectionModelArrayList.size() > 0) {
                                    ...
                                    ArrayAdapter<String> spinnerPhoneArrayAdapter2 = new ArrayAdapter<String>(AseStoreWiseReportActivity.this, R.layout.spinner_item, products);
    ...
    public void submitReportData() {
        GlobalVariable.store_report_date_from = etStartDate.getText().toString();
        GlobalVariable.store_report_date_to = etEndDate.getText().toString();
        GlobalVariable.store_report_collection = selected_collection;
       // GlobalVariable.store_report_style_no = etProductStyle.getText().toString();

        startActivity(new Intent(AseStoreWiseReportActivity.this, AseStoreWiseReportResultActivity.class));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AseStoreWiseReportActivity.this, TaskActivity.class);
