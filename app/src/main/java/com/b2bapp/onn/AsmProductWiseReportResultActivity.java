...
public class AsmProductWiseReportResultActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asm_product_wise_report_result);
        ...
        asm = pref.getStringPreference(AsmProductWiseReportResultActivity.this,Preferences.User_fname)
                + " "+ pref.getStringPreference(AsmProductWiseReportResultActivity.this,Preferences.User_lname);
        ...
        productWiseSalesAdapter = new ProductWiseSalesAdapter(AsmProductWiseReportResultActivity.this,productWiseSalesModelArrayList);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AsmProductWiseReportResultActivity.this, AsmProductWiseReportActivity.class);
    ...
    private void getAllData(){
        dialogView.showCustomSpinProgress(AsmProductWiseReportResultActivity.this);
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                WebServices.URL_ASM_WISE_PRODUCT_REPORT, new JSONObject(postParam),
...
//                                        dataModel.setProductWiseSalesDetailsModelArrayList(productWiseSalesDetailsModelArrayList);
                                ...
                                dialogView.showSingleButtonDialog(AsmProductWiseReportResultActivity.this, getResources().getString(R.string.app_name),
