...
public class AseSalesReportActivity extends AppCompatActivity implements View.OnClickListener {

    private EditText etStartDate, etEndDate;
    final Calendar myCalendar= Calendar.getInstance();

    private String ase = "";
//    private String start = "06-07-2022";
//    private String end = "06-07-2022";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ase_sales_report);
        ...
        ase = pref.getStringPreference(AseSalesReportActivity.this,Preferences.User_fname)
                + " "+ pref.getStringPreference(AseSalesReportActivity.this,Preferences.User_lname);
        ...
        etStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(AseSalesReportActivity.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        etEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(AseSalesReportActivity.this,date1,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        asePrimaryReportAdapter = new AsePrimaryReportAdapter(AseSalesReportActivity.this, asePrimaryReportModelArrayList);
        primaryList.setAdapter(asePrimaryReportAdapter);

        secondaryList = (ListView) findViewById(R.id.secondaryList);
        aseSecondaryReportAdapter = new AseSecondaryReportAdapter(AseSalesReportActivity.this, aseSecondaryReportModelArrayList);
        ...
        primaryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                startActivity(new Intent(AseSalesReportActivity.this, AseDistributorOrderListActivity.class));
        ...
        secondaryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                StoreOrderListActivity.coming_from = "sales_report";
                startActivity(new Intent(AseSalesReportActivity.this, StoreOrderListActivity.class));
                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                finish();
            }
        });
    ...
    private void getAllData(){
        dialogView.showCustomSpinProgress(AseSalesReportActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                dialogView.showSingleButtonDialog(AseSalesReportActivity.this, getResources().getString(R.string.app_name),
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AseSalesReportActivity.this, TaskActivity.class);
