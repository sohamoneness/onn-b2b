...
public class StoreListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DbHelper(StoreListActivity.this);

        ase = pref.getStringPreference(StoreListActivity.this,Preferences.User_fname)
                + " "+ pref.getStringPreference(StoreListActivity.this,Preferences.User_lname);
...
//        }
        //Calling getStoreListTask method
        //getStoreListTask();
        if (ConnectionStatus.checkConnectionStatus(StoreListActivity.this)) {
            //Calling getStoreListTask method
            getStoreListTask();
        }else{
            Log.d("Conenction status>>","not connected to internet");
            storeModelArrayList = dbHelper.fetchStoreList();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.imgSearch:
                ...
                break;
            case R.id.imgAdd:
                startActivity(new Intent(StoreListActivity.this, StoreAddActivity.class));
                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                finish();
                break;
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(StoreListActivity.this, TaskActivity.class);
    ...
    public void getStoreListTask(){
        dialogView.showCustomSpinProgress(StoreListActivity.this);
