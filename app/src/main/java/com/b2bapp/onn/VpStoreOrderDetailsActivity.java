...
public class VpStoreOrderDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vp_store_order_details);
        ...
        itemAdapter = new ItemAdapter(VpStoreOrderDetailsActivity.this,itemModelArrayList);
    ...
    public void getOrderDetailsTask(){
        dialogView.showCustomSpinProgress(VpStoreOrderDetailsActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(VpStoreOrderDetailsActivity.this, VpStoreOrdersActivity.class);
