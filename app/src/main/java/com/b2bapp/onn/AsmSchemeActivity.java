...
public class AsmSchemeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asm_scheme);
        ...
        schemeAdapter = new SchemeAdapter(AsmSchemeActivity.this,currentSchemeModelArrayList);
...
//                finish();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.tvOld:
                ...
                schemeAdapter = new SchemeAdapter(AsmSchemeActivity.this,oldSchemeModelArrayList);
                gvSchemes.setAdapter(schemeAdapter);
                break;
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AsmSchemeActivity.this, RsmDashboardActivity.class);
    ...
    public void getSchemesTask(){
        dialogView.showCustomSpinProgress(AsmSchemeActivity.this);
