...
public class AsmStoreOrdersActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asm_store_orders);
        ...
        storeOrderAdapter = new StoreOrderAdapter(AsmStoreOrdersActivity.this,orderModelArrayList);
        ...
        orderList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                AsmStoreOrderDetailsActivity.orderModel = orderModelArrayList.get(i);
                startActivity(new Intent(AsmStoreOrdersActivity.this, AsmStoreOrderDetailsActivity.class));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AsmStoreOrdersActivity.this, AsmStoreActivity.class);
    ...
    public void getStoreListTask(){
        dialogView.showCustomSpinProgress(AsmStoreOrdersActivity.this);
