...
public class RsmWiseAsmActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsm_wise_asm);
        ...
        rsm = pref.getStringPreference(RsmWiseAsmActivity.this,Preferences.User_fname)
                + " "+ pref.getStringPreference(RsmWiseAsmActivity.this,Preferences.User_lname);
        state = pref.getStringPreference(RsmWiseAsmActivity.this,Preferences.User_State);

        asmAdapter = new AsmAdapter(RsmWiseAsmActivity.this, asmModelArrayList);
        ...
        asmList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                RsmAseActivity.state = state;
                RsmAseActivity.asm = asmModelArrayList.get(i).getName();
                startActivity(new Intent(RsmWiseAsmActivity.this, RsmAseActivity.class));
    ...
    private void getAllData(String state, String rsm){
        dialogView.showCustomSpinProgress(RsmWiseAsmActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                dialogView.showSingleButtonDialog(RsmWiseAsmActivity.this, getResources().getString(R.string.app_name),
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(RsmWiseAsmActivity.this, RsmDashboardActivity.class);
